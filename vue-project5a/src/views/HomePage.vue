<template>
  <div id="content" class="no-bottom no-top">
    ...
    <section class="no-top no-bottom jarallax vertical-center" data-video-src="mp4:src/assets/video/local-video.mp4">
          ...
          <div class="col-lg-4">
            <div class="de-room">
              ...
              <div class="d-text">
                ...
                <a href="02-room-single.html" class="btn-line"
                  ><span>Book Now For $29</span></a
                >
              </div>
            </div>
          </div>
