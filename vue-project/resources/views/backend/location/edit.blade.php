            ...
            <div class="card-body">
                <form method="post" action="{{ route('location.update',$location->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"name="location_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$location->location_name}}" placeholder="Enter Loaction Name">
